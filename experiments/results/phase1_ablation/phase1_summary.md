...
**vpred + sigmoid** is the recommended base configuration for Phase 2 experiments. At full scale (128 channels, 400 epochs), this combination achieved:
- SF: 3/6, MMD: 0.020, Disc: 0.66, W1: 0.176, CorrDist: 6.655

Remaining failures to address in Phase 2:
1. **Fat tails**: Kurtosis = 0.04 (need >> 0, real = 14.03)
2. **Volatility clustering**: ARCH-LM p = 0.73 (need < 0.05)
3. **Slow ACF decay**: n_positive = 10/20 (need >= 15)
